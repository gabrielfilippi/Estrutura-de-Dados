...
import Functions.QuickSortProduct;
...
public class HomeUI extends JFrame {
	...
	public void setLayout() {
		...
		dataModel = new DefaultTableModel() {
			...
			public String getColumnName(int columnIndex) {
				String v[] = {"Nome", "Preço", "Avaliação", "Qtde de Vendas", "Data de Lançamento"};
		...
		statusBar .setText("Selecione uma forma de ordenação.");
	...
	private void ordernarLista() {
		...
		//System.out.println(listaDeProdutos.get(0).getAvaliacao());
		QuickSortProduct.quickSort(listaDeProdutos, 0, listaDeProdutos.size()-1, cbOrdernarPor.getSelectedIndex());
