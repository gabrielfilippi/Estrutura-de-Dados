...
public class TestesBubbleSort {

	
	@Test
	void exercicio01() {
		int a[] = {4,2,-9,78,8};
		int retorno[] = BubbleSort.exercicio01(a);
		int esperado[] = {-9,2,4,8,78};
		assertArrayEquals(esperado,retorno,"O vetor deve estar ordenado");
		int b[] = {0,2,1,1,2};
		retorno = BubbleSort.exercicio01(b);
	...
	void exercicio02() {
		int a[] = {4,2,-9,78,8};
		int retorno[] = BubbleSort.exercicio02(a);
		int esperado[] = {78,8,4,2,-9};
		assertArrayEquals(esperado,retorno,"O vetor deve estar ordenado");
		int b[] = {0,2,1,1,2};
		retorno = BubbleSort.exercicio02(b);
	...
	void exercicio03() {
		...
		String retorno[] = BubbleSort.exercicio03(entrada);
		String esperado[] = {"a","b","c","z"};
		assertArrayEquals(esperado,retorno,"O vetor deve estar ordenado");
		String entrada2[] = {"k","m","e","b"};
		String retorno2[] = BubbleSort.exercicio03(entrada2);
	...
	void exercicio04() {
		...
		Produto retorno[] = BubbleSort.exercicio04(entrada);
	...
	void exercicio05() {
		Produto entrada[] = {new Produto("Tenis Nike",299.99)
							...
							,new Produto("Tenis Adida",227.99)
							,new Produto("Camisa Polo",99.99)};
		Produto retorno[] = BubbleSort.exercicio05(entrada);
